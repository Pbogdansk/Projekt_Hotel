...
Reservation Receptionist::reservation(Room* pointerRoomToReserve, int startingDate, int endingDate, Customer* newCustomer, BookIn* newBookIn) {
	return Reservation(startingDate, endingDate, false, pointerRoomToReserve, newCustomer, newBookIn);
}